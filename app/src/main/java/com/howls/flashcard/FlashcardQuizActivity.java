...
public class FlashcardQuizActivity extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            if (activity.getQuiz().equals("Sounds")) {
            ...
            if (!activity.getQuiz().equals("Translate")) {
                ...
                if (num == 1) {
                    option1.setText(flashcard.getWord());

                    int val = rand.nextInt((flashcards_options.size()));
                    option2.setText(flashcards_options.get(val).getWord());
                    int val1 = rand.nextInt((flashcards_options.size()));
                    option3.setText(flashcards_options.get(val1).getWord());
                ...
                if (num == 2) {
                    option2.setText(flashcard.getWord());
                    int val = rand.nextInt((flashcards_options.size()));
                    option1.setText(flashcards_options.get(val).getWord());
                    int val1 = rand.nextInt((flashcards_options.size()));
                    option3.setText(flashcards_options.get(val1).getWord());
                ...
                if (num == 3) {
                    option3.setText(flashcard.getWord());
                    int val = rand.nextInt((flashcards_options.size()));
                    option2.setText(flashcards_options.get(val).getWord());
                    int val1 = rand.nextInt((flashcards_options.size()));
                    option1.setText(flashcards_options.get(val1).getWord());
                ...
                TextView term = rootView.findViewById(R.id.term);
                term.setText(flashcard.getTranslate());
            }
